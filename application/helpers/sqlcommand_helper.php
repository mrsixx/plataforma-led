...
Busque ser gentil e educado em suas publicações e comentários com os outros membros, assim eles estarão propensos a encarar melhor suas ideias :D")."', '".utf8_decode("Mural")."', NULL);",
			...
			'inteligencia' => "INSERT INTO `".$prefix."inteligencia` (`CodInteligencia`, `Nome`, `Descricao`,`Icon`,
					 ...
					 (NULL, '".utf8_decode("Interpessoal")."', '".utf8_decode("Capacidade de interagir de forma efetiva com outras pessoas, responder apropriadamente aos temperamentos, humores, motivação, compreender e motivar. Mais presente em políticos, vendedores, professores, líderes e diversas pessoas que trabalham com motivação. Personalidade famosa com esse tipo de inteligência: Freud, Gandhi.")."', 'fa fa-thumbs-o-up fa-2x', 'card-interpessoal', 'progress-bar-interpessoal'),
