				...
				<form method="POST" name="frmCriaTask" id="frmCriaTask" action="/task/criaTask" enctype="multipart/form-data">
						...
						<div class="col-md-6 col-sm-12 col-xs-12">
							<div class="funkyradio">
								<div class="funkyradio-secondary">
									...
									<label for="checkbox6">Inteligência intrapessoal</label>
								</div>
								<div class="funkyradio-quintly">
									<input type="checkbox" name="chkInteligencia[]" value="6" id="checkbox7" />
									<label for="checkbox7">Inteligência interpessoal</label>
								</div>
								<div class="funkyradio-tertiary">
									<input type="checkbox" name="chkInteligencia[]" value="7" id="checkbox8" />
									<label for="checkbox8">Inteligência naturalista</label>
								</div>
								<div class="funkyradio-quarterly">
									<input type="checkbox" name="chkInteligencia[]" value="8" id="checkbox9" />
									<label for="checkbox9">Inteligência existencial</label>
								</div>
								<div class="funkyradio-info">
									<input type="checkbox" name="chkInteligencia[]" value="10" id="checkbox10" checked disabled />
									<label for="checkbox10">Inteligência prática</label>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="btn-group pull-right">
							<button type="submit" class="btn btn-success" id="enviarTask">Salvar e enviar missão</button>
										...
										<div class="row">
											<div class="col-md-5">
												<?php if(!empty($missoes['CaminhoArquivo'])):?>
													<a class="btn btn-warning" href="/data/tasks/professores/<?php echo $missoes['CaminhoArquivo'];?>" download>Download da missão</a>
												<?php endif; ?>
												<?php if($missoes['Prazo'] >= date('Y-m-d H:i') && !$enviado):?>
								...
								<div class="col-md-9 col-lg-9 col-sm-12 "> 
									<table class="table table-user-information">
										<tbody>
											<tr>
												<td>Professor:</td>
												<td><?php echo utf8_encode($missoes['NomeUser']." ".$missoes['Sobrenome']);?></td>
											</tr>
											<tr>
											...
											<tr>
												<td>Contato:</td>
												<td>
													<a type="button" href="/chat/messages/?t=ind&id=<?php echo $missoes['Token'];?>" class="btn btn-primary" >Enviar mensagem</a>
												</td>
											</tr>
										</tbody>
									</table>
					...
					<div class="row">
						...
						<div class="col-md-6 col-xs-12">
							...
							<?php else:?>
								...
								<div class="panel" style="background-color: #fff;">
									<div>
										<img src="<?php echo base_url('assets/img/avatar/corpo/corpo(1).png');echo "?".time();?>" id="corpo">
									</div>
								</div></center>
							<?php endif; ?>
							</div>
							<div class="col-md-6 col-xs-12">
								<div class="panel"  style="min-height: 200px; background-color: #fff;">
									<center><?php echo '<h3>'.$nickname.'</h3>';?></center><br/>
									<center>Lvl. <?php echo $lvl;?></center><br/>
									<div class="progress">
								        <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="4" aria-valuemin="0" aria-valuemax="100" style="width:<?php echo $porcentagem;?>%;transition-timing-function: step-start;" ></div>
								    </div>
