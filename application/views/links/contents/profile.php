...
$foto = fotoPerfil($infoUser['Foto'],$infoUser['Sexo']);
$capa = (!empty($infoUser['Foto'])) ? $foto : base_url("/assets/img/capa_led.jpg");
    ...
    <div class="row">
        <div class="fb-profile">
            <div class="perfil_capa">
                <img align="left" class="fb-image-lg filtro" src="<?php echo $capa;?>" alt="Capa" />
            </div>
            <div class="filtro1">
                <img align="left" class="fb-image-profile img-circle thumbnail" src="<?php echo $foto;?>" alt="Foto de perfil" />
            </div>
        </div>
        ...
        <div class="fb-profile-text ">
            ...
            <?php if($infoUser['CodUsuario'] == $codUsuario):?>
                ...
                <div class="pull-right">
                    <a href="/chat/messages?t=ind&id=<?php echo $infoUser['Token']; ?>" class="btn"><i class="glyphicon glyphicon-comment"></i> <strong>Enviar mensagem</strong></a>
                        ...
                        <div class="panel <?php echo $classecard; ?>">
                            <div class="panel-heading">
                                <p title="<?php echo utf8_encode($infoUser['Nickname']); ?> card"><i class="fa fa-smile-o fa-lg"></i>
                                    <?php $iconcard = ($tipo == 4)?"fa fa-graduation-cap fa-2x": $iconcard;?>
                            ...
                            <div class="col-xs-12 col-sm-12  col-md-8">
                                <?php if($infoUser['CodTipoUsuario'] == 3 || $infoUser['CodTipoUsuario'] == 4): ?>
                                    <div class="panel with-nav-tabs card-danger" style="min-height: 387px;">
                                        <div class="panel-heading">
                                            <ul class="nav nav-tabs">
                                                <li class="active"><a href="#default" data-toggle="tab"><i class="fa fa-globe" aria-hidden="true"></i></a></li>
                                                <?php
                                                foreach ($inteligencia as $int):
                                                    $href = "inteligencia".$int->CodInteligencia;
